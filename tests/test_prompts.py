...
class TestPromptRegistry:
    ...
    def test_list_prompts_returns_available_prompts(self) -> None:
    ...
    def test_list_variants_for_signal_classification(self) -> None:
    ...
    def test_get_claude_variant(self) -> None:
    ...
    def test_get_openai_variant(self) -> None:
    ...
    def test_get_gemini_variant(self) -> None:
    ...
    def test_auto_detect_provider_from_gpt_model(self) -> None:
    ...
    def test_auto_detect_provider_from_claude_model(self) -> None:
    ...
    def test_auto_detect_provider_from_gemini_model(self) -> None:
    ...
    def test_has_provider_variant_returns_true_for_existing(self) -> None:
    ...
    def test_has_provider_variant_returns_false_for_nonexistent(self) -> None:
    ...
    def test_provider_and_model_both_specified_raises_error(self) -> None:
...
class TestConvenienceFunctions:
    ...
    def test_get_prompt_convenience_function(self) -> None:
    ...
    def test_list_prompts_convenience_function(self) -> None:
    ...
    def test_list_variants_convenience_function(self) -> None:
...
class TestProviderDetection:
    ...
    def test_provider_detection_from_model_name(
        self, model_name: str, expected_provider: str
    ) -> None:
...
class TestPromptContent:
    ...
    def test_base_prompt_contains_categories(self) -> None:
    ...
    def test_claude_variant_contains_xml_tags(self) -> None:
    ...
    def test_openai_variant_contains_function_definition(self) -> None:
    ...
    def test_gemini_variant_contains_json_schema(self) -> None:
...
class TestPromptMetadata:
    ...
    def test_all_variants_have_category_info(self) -> None:
    ...
    def test_variants_include_examples(self) -> None:
...
class TestEdgeCases:
    ...
    def test_list_variants_for_nonexistent_prompt(self) -> None:
        """Test list_variants returns empty dict for non-existent prompt."""
        variants = PromptRegistry.list_variants("nonexistent-prompt")
        assert variants == {}

    def test_has_provider_variant_for_nonexistent_prompt(self) -> None:
    ...
    def test_resolve_prompt_path_with_md_extension(self) -> None:
    ...
    def test_fallback_to_base_when_provider_variant_missing(self) -> None:
    ...
    def test_auto_detect_with_unknown_model_uses_base(self) -> None:
    ...
    def test_list_prompts_is_sorted(self) -> None:
        """Test that list_prompts returns sorted list."""
        prompts = PromptRegistry.list_prompts()
        assert prompts == sorted(prompts)

    def test_get_prompt_with_provider_prefers_provider_variant(self) -> None:
    ...
    def test_prompt_path_resolution_case_sensitivity(self) -> None:
    ...
    def test_prompt_path_resolution_returns_none_for_invalid(self) -> None:
        """Test that invalid prompt path returns None."""
        path = PromptRegistry._resolve_prompt_path("invalid/nonexistent/path")
        assert path is None

    def test_error_when_directory_exists_but_no_prompt_files(self, tmp_path: Path) -> None:
    ...
    def test_list_prompts_when_no_prompts_dir(self, tmp_path: Path) -> None:
