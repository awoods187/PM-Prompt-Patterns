...
**Comprehensive prompt for reviewing executive presentations through the lens of a C-suite panel (CEO, CFO, CRO, CPO, CTO).**
...
prompt = get_prompt("stakeholder-communication/executive-deck-review", model=model.id)
...
claude_prompt = get_prompt("stakeholder-communication/executive-deck-review", provider="claude")
openai_prompt = get_prompt("stakeholder-communication/executive-deck-review", provider="openai")
